...
<div id="panel_app">
  ...
  <div id="post_box">
    ...
    <?php echo form_open_multipart('twitter/edit/'. $tweet['tweets_id'],'onsubmit="send()"');?>
      <br>
      ...
      <input type="file" id="txt_file" name="txt_file" size="20" class="btn btn-info" accept="image/jpeg,image/gif,image/png,.pdf,.txt,.docx,.xlsx,.pptx" />
