  ...
  <div id="div_comentarios">
    ...
    <?php foreach ($calificacion as $c) {
      if ($c['comentario'] == null) { ?>
        ...
        <?php echo form_close(); ?>
      <?php } else { ?>
        <input type="text" name="txt_comentario" id="txt_comentario" placeholder="Comentario" disabled="true" value="<?php echo $c['comentario'] ?>" style="width:310px; height:30px; border-radius:10px; border-style:ridge; border-color:black; font-size:13px; float:left; color:white;">
        <input type="text" name="txt_comentario" id="txt_comentario" placeholder="Respuesta" disabled="true" value="<?php echo $c['respuesta'] ?>" style="width:310px; margin-top:10px; height:30px; border-radius:10px; border-style:ridge; border-color:black; font-size:13px; float:left; color:white;">
      <?php } ?>
    <?php } ?>
