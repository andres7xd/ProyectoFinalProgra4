...
class Reporte_compras extends CI_Controller
{
    ...
    function index()
    {
        ...
        $data['datos_grafico'] = $this->Reporte_compras_model->get_datos_grafico($this->session->userdata['logged_in']['usuario_id'], $this->input->post('fecha_1'), $this->input->post('fecha_2'));
