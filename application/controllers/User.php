...
class User extends CI_Controller
{
    ...
    function edit($users_id)
    {
        ...
        $data['redes'] = $this->User_model->get_redes($this->session->userdata['logged_in']['usuario_id']);
    ...
    function delete_red($id_red_social)
    {
        $this->User_model->delete_red($id_red_social);
    ...
    function add_red()
    {
        $params = array(
            ...
            'tipo_red' =>  $this->input->post('select_categoria'),
            'nombre_red' =>  $this->input->post('txt_nombre_red'),
        );
        $this->User_model->add_red($params);
